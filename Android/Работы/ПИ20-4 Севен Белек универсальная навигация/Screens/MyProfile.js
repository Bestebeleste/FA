...
export default function MyProfile () {
  return (<ScrollView style={{marginTop:20}}>
    ...
    <Text style={{ justifyContent: 'center', alignSelf:'center', fontWeight: 'bold', fontSize:30, fontFamily:'lucida grande', margin:10}}>Бульк</Text>
    ...
    <Text>89585161897</Text>
    </Card>
    <Card>
    <Text style={{ fontWeight: 'bold' }}>Email</Text>
    <Text>belek_seven@mail.ru</Text>
    </Card>
  </ScrollView>
);
}