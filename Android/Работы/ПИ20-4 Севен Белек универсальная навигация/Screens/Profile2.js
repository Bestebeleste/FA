...
export default function Profile2() {
  return (<ScrollView style={{marginTop:20}}>
    ...
    <Text style={{ justifyContent: 'center', alignSelf:'center', fontWeight: 'bold', fontSize:30, fontFamily:'lucida grande', margin:10}}>Бойду</Text>
    ...
    <Text>85630248626</Text>
    </Card>
    <Card>
    <Text style={{ fontWeight: 'bold' }}>Email</Text>
    <Text>boydu@mail.ru</Text>
    </Card>
  </ScrollView>
);}