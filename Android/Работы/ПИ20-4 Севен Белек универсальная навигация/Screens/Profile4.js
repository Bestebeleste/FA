...
export default function Profile4() {
  return (<ScrollView style={{marginTop:20}}>
    ...
    <Text style={{ justifyContent: 'center', alignSelf:'center', fontWeight: 'bold', fontSize:30, fontFamily:'lucida grande', margin:10}}>Тинмей</Text>
    ...
    <Text>88006283572</Text>
    </Card>
    <Card>
    <Text style={{ fontWeight: 'bold' }}>Email</Text>
    <Text>tinmeij@mail.ru</Text>
    </Card>
  </ScrollView>
);}