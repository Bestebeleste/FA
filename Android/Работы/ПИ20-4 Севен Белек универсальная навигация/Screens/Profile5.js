...
export default function Profile5() {
  return (<ScrollView style={{marginTop:20}}>
    ...
    <Text style={{ justifyContent: 'center', alignSelf:'center', fontWeight: 'bold', fontSize:30, fontFamily:'lucida grande', margin:10}}>Чаян</Text>
    ...
    <Text>89394656582</Text>
    </Card>
    <Card>
    <Text style={{ fontWeight: 'bold' }}>Email</Text>
    <Text>kilizhekov@mail.ru</Text>
    </Card>
  </ScrollView>
);}